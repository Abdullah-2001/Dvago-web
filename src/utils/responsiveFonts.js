export const size = {
  h1: "clamp(2rem, 4vw + 1rem, 3rem)", // ~32px to 48px
  h2: "clamp(1.5rem, 3vw + 0.5rem, 2.5rem)", // ~24px to 40px
  h3: "clamp(1.25rem, 2.5vw + 0.25rem, 2rem)", // ~20px to 32px
  h4: "clamp(1rem, 2vw, 1.5rem)", // ~16px to 24px
