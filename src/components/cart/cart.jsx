    ...
    return (
        <div>
            ...
            <header className="flex items-center justify-between px-5 py-4 border-b" style={{ borderColor: colors.lightGrey3 }}>
                <div>
                    <h3 className="font-semibold" style={{ fontSize: size.paragraph }}>Your Cart</h3>
            ...
            <div className="p-4">
                <div className="space-y-3">
                    ...
                    <div className="flex justify-between items-center pt-2 border-t" style={{ borderColor: colors.lightGrey3 }}>
                        <span className="font-semibold" style={{ fontSize: size.paragraph }}>Total</span>
                        <span className="font-bold" style={{ fontSize: size.paragraph }}>${subTotal}</span>
                    </div>

                    <div className="pt-3 flex flex-col gap-2">
                        <Button className={`font-semiBold py-[15px] px-[15px] h-10 rounded-full w-full`}>Checkout</Button>
                        <Button
